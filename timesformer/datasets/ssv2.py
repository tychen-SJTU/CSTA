...
from timesformer.datasets.transforms import ToTorchFormatTensor, Stack, GroupNormalize, GroupMultiScaleCrop, GroupRandomHorizontalFlip
...
class Ssv2(data.Dataset):
    ...
    def _parse_list(self):
        ...
        self.video_list = [VideoRecord(item) for item in tmp if (int(item[2])in self.task_list and os.path.exists(os.path.join(self.root_path, item[0])))]
