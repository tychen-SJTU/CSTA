...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="./configs/SSv2/TimeSformer_divST_8_224.yaml",
        type=str,
    )
    parser.add_argument(
        "opts",
    ...
    parser.add_argument('--nb_class', default=20, type=int, help='class batch')
    parser.add_argument('--init_task', default=20, type=int, help='size of the initial task')
    parser.add_argument('--start_task', default=0, type=int, help='starting task')
    parser.add_argument('--end_task', default=10, type=int, help='last task')
    parser.add_argument('--train_list', type=str,
                        default="./")
    parser.add_argument('--val_list', type=str,
                        default="./")
    parser.add_argument('--root_path', type=str, default="./")
    parser.add_argument('--casual_loss_weight', default=0.25, type=float, help='casual_loss_weight')
    ...
    parser.add_argument('--supervise_loss', default=False, type=bool, help='whether use supervise loss or not')
    parser.add_argument('--casual', default=False, type=bool, help='whether use causal or not')
    parser.add_argument('--adapter', default=True, type=bool, help='whether use adapter or not')
    parser.add_argument('--val_epoch', default=2, type=int, help='from which epoch start validate')
